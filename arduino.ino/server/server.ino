...
const char* ssid = "PLDTHOMEFIBRS7y9S";
const char* password = "familyParian143@";
const char* device_token  = "01f436a3f39084ae";
...
void loop() {
  ...
  digitalWrite(ON_Board_LED, HIGH);
    ...
    WiFiClient client;
     const char * host = "192.168.1.45";            //default IP address
  ...
  String url = "/data/";
  url += "?sensor_reading=";
  url +=  "{\"sensor_reading\":\"sensor_value\"}";
  url.replace("sensor_value", String(state));
